#!/usr/bin/env python3
"""
Run a sample task with Agent-S in hybrid mode
This script demonstrates how to run Agent-S with the hybrid agent that can switch between GUI and coding modes.
...
MAIN_MODEL = "gpt-4o"              # Model name (e.g., gpt-4o, claude-3-5-sonnet-20241022)
MAIN_MODEL_URL = ""                # Custom API URL (optional)
MAIN_API_KEY = ""                  # Custom API key (optional, uses env vars if empty)
TEMPERATURE = 0.7                  # Temperature setting for creativity (0.0 = deterministic, 2.0 = very creative)
...
print("Agent-S Hybrid Task Runner")
print("==========================\n")
...
default_args = [
    ...
    "--agent_mode", "hybrid",  # Use hybrid mode
]
