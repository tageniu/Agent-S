...
from coact.coding_agent import TerminalProxyAgent, CODER_SYSTEM_MESSAGE
from coact.operator_agent import OrchestratorAgent

logger = logging.getLogger("desktopenv.agent")


class CodingWorker(BaseModule):
    def __init__(
        self,
        engine_params: Dict,
        grounding_agent: ACI,
        ...
        """
        CodingWorker receives the main task and generates code actions, with the ability to execute code
        Args:
            engine_params: Dict
